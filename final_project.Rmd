...
```
```{r}
rf_fit1 <- randomForest(new_case ~ Administered, data = trainset)
rf_preds1 <- predict(rf_fit1, testset)
testset%>%
  ggplot()+geom_line(aes(date,rf_preds1),color="red")+geom_point(aes(date,new_case))
#rf_preds1
```
